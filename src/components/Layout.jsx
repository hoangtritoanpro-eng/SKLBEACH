...
const NAV = {
  ADMIN:   [
    ...
    { icon: '📑', label: 'Đề thi',       path: '/exams' },

    { icon: '👥', label: 'Người dùng',   path: '/users' },
    { icon: '🎙️', label: 'Báo cáo GVBM', path: '/class-reports' },
    { icon: '✔️', label: 'Duyệt Báo cáo',path: '/approvals' },
    { icon: '📖', label: 'Sổ báo bài',   path: '/lessons' },
    { icon: '⚠️', label: 'Vi phạm',      path: '/violations' },
    { icon: '⭐', label: 'Tích điểm',    path: '/points' },
    { icon: '📢', label: 'Thông báo',    path: '/notices' },
    { icon: '📚', label: 'Thư viện',     path: '/library' },
  ],
  TEACHER: [
    ...
    <div className="app-layout">
      ...
      <main className="main-content">
        <div className="mobile-header">
          ...
          <span style={{ fontWeight: 700, fontSize: '1rem', color: 'white' }}>🎓 Trung học Beach</span>
          <div />
        </div>
        <Outlet />
      </main>
